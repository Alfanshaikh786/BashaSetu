...
1. **Frontend Page & Components:**
   - `src/pages/features/SpeechToSpeechPage.tsx` — Full Voice-to-Voice UI, dual-speaker conversational interface, green live streaming bubble, red active mic button, audio triggers, and quick phrases.

2. **Core S2S / Voice Translation Services (`src/services/s2s/` — ALL 23 FILES):**
